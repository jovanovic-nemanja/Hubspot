          ...
          <div class="row">
            <div class="col-md-12">
              <div class="setup-message">
                ...
                <!-- <p>
                  Modules Page has been updated!
                  <a
                    v-bind:href="pageInformation.results.data.url"
                    target="_blank"
                  ...
                  <a
                    ...
                    v-bind:href="
                      'https://app.hubspot.com/content/' +
                        hub_id +
                        '/edit/' +
                        pageInformation.results.data.page_id +
                        '/content'
                    "
                    target="_blank"
                    rel="noopener noreferrer"
...
export default {
  ...
  beforeMount: function() {
    ...
    this.pageInformation = JSON.parse(localStorage.pageCreated);
    this.hub_id = JSON.parse(localStorage.portalData).hub_id;
  }
};
</script>
