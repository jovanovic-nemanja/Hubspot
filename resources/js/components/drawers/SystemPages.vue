  ...
  methods: {
    getModules(params) {
      if (this.$route.params.id !== undefined) {
        axios
          .get("/api/v1/modules/system-pages", { params })
          .then(res => {
            this.modules = res.data.data;

            for (let index = 0; index < this.modules.length; index++) {
              this.modules[index].button_state = "Add Template";
    ...
    installModule(module, index) {
      this.closeAlert();
      this.modules[index].button_state = "Adding Template...";
      ...
      axios
        ...
        .then(res => {
          this.showAlert = true;
          this.options.content = module.name + " has been installed";
